...
def Correlation(file,Clablesize,dpi,Ytick,Xtick,y_font,x_font,clable,center,data,datasize,cmap,vmin,vmax,y,x,ylabelsize,xlabelsize,y_rotation,x_rotation,scale,cbar,cbarscale,cbarsize,linewidths,linecolor,square,ycolor,xcolor):
    # Data set
    ...
    sns_plot = sns.heatmap(corr_matrix,center = centers,annot=datas,annot_kws={"size": datasizes},cmap=cmap,vmin=vmins,vmax =vmaxs,yticklabels=ys,xticklabels=xs,cbar_kws={"orientation":cbars,"shrink": cbarscales},linewidths=linewidths,linecolor=linecolor,square=squares)
