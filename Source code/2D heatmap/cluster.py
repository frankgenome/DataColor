...
def cluster(file,Cbarsize,clable,Clablesize,dpi,cblock,y_font,x_font,Class,robust,data,datasize,cmap,vmin,vmax,y,x,cbar,cbarscale,linewidths,linecolor,square,row_cluster,col_cluster,ylabelsize,xlabelsize,y_rotation,x_rotation,ycolor,xcolor,metric,method,treestyle,treecolor,treewidths):
