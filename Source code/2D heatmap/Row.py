...
def Row(file,Clablesize,dpi,Ytick,Xtick,y_font,x_font,clable,center,data,datasize,cmap,vmin,vmax,y,x,ylabelsize,xlabelsize,y_rotation,x_rotation,scale,cbar,cbarscale,cbarsize,linewidths,linecolor,square,ycolor,xcolor):
    ...
    fig.subplots_adjust(bottom=0.224, left=0.185, right=0.935)
    #data,datasize
    if data == 'Yes':
      datas = True
    else:
