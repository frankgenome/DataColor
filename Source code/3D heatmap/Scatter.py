...
def Scatter(file,dpi,y_font,x_font,x,y,cmap,ylabelsize,xlabelsize,y_rotation,x_rotation,ycolor,xcolor,zlabelsize,z_rotation,zcolor,clable,cbars,cbarscale,clocation,cbarsize,Clablesize,titlem,xlable,ylable,zlable):
    # creating figures
    if clable == 'None' :
      clables = None
    else:
